...
def tf(term, document)
  tee_ef = document.split(/[\s-]/).count { |word| word.downcase == term }
  # p "tee_ef = #{tee_ef}"
  tee_ef
...
def idf(term, documents)
  ...
  # p "number_of_documents == #{number_of_documents}," +
  #   "number_of_documents_with_term = #{number_of_documents_with_term}"
  # p "i_dee_ef == #{Math.log(number_of_documents.to_f / number_of_documents_with_term)}"
